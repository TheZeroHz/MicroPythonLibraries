"""
LCD API Base Class
Core functionality for character LCD displays
"""
...
class LcdApi:
    """Provides an API for talking to character lcds."""
    ...
    def __init__(self, num_lines, num_columns):
        ...
        Args:
            num_lines: Number of display lines (max 4)
            num_columns: Number of columns per line (max 40)
        """
    ...
    def display_on(self):
        """Turns on (unblanks) the LCD."""
        self.hal_write_command(self.LCD_ON_CTRL | self.LCD_ON_DISPLAY)

    def display_off(self):
        """Turns off (blanks) the LCD."""
    ...
    def move_to(self, cursor_x, cursor_y):
        ...
        Args:
            cursor_x: Column position (0 to num_columns-1)
            cursor_y: Row position (0 to num_lines-1)
        """
